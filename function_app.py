...
WORKFLOW_CONFIGS = {
    ...
    "meta": {
        "rate_limit_rpm": 20,  # Reduced from 10 to be more conservative
        "delay": 20,
        "activity_name": "meta_processor",
        "max_retries": 3
    }
}
...
def generic_orchestrator(context: df.DurableOrchestrationContext):
    orchestrator_logic(context, WORKFLOW_CONFIGS)
